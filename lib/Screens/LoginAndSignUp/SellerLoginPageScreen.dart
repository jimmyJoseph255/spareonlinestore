...
import 'package:myproject/Screens/LoginAndSignUp/SellerOtpPage.dart';
import 'package:myproject/api_services/auth/auth_sslDisabled.dart';
import 'package:myproject/controller.dart';
import 'package:myproject/phone_number.dart'; // Ensure this exists

class Sellerloginpagescreen extends StatefulWidget {
  @override
  _SellerloginpagescreenState createState() => _SellerloginpagescreenState();
}
        ...
        if (response.statusCode == 200) {
          ...
          Future.delayed(const Duration(seconds: 0), () {
            Navigator.pushReplacement(
              context,
              MaterialPageRoute(
                builder: (context) => SellerOtpPage(mobile: mobile),
              ),
            );
          });
        } else {
