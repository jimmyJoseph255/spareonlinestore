...
import 'package:myproject/Screens/Products/tyredetailsinside.dart';
...
class _TyreDetailsScreenState extends State<TyreDetailsScreen> {
  ...
  Future<void> _loadToken() async {
    ...
    if (_token != null) {
      print('Token loaded in TyreDetailsScreen: $_token');
      _fetchProducts();
    } else {
      print('No token found in TyreDetailsScreen');
  ...
  Future<void> _fetchProducts() async {
    try {
      final products = await ApiService.fetchTyreProducts(token: _token);
      print('Fetched tyre products: $products');
      ...
      print('Error fetching tyre products: $e');
      setState(() => _isLoading = false);
    }
  }
