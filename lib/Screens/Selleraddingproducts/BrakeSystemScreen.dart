...
class BrakeSystemScreen extends StatefulWidget {
  const BrakeSystemScreen({super.key});

  @override
  _BrakeSystemScreenState createState() => _BrakeSystemScreenState();
}

class _BrakeSystemScreenState extends State<BrakeSystemScreen> {
  final TextEditingController _brakeSystemNameController =
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Add Brake System'),
        backgroundColor: const Color.fromARGB(255, 67, 164, 243),
        elevation: 0,
      ),
      body: Padding(
        ...
        child: SingleChildScrollView(
          child: Form(
            ...
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                _buildTextField('Name', _brakeSystemNameController,
                    validator: (value) {
                  if (value == null || value.isEmpty) {
                    return 'Please enter brake system name';
                  }
                  return null;
                }),
                _buildTextField(
