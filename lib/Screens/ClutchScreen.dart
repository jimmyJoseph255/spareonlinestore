...
class ClutchScreen extends StatefulWidget {
  ...
  @override
  _ClutchScreenState createState() => _ClutchScreenState();
}

class _ClutchScreenState extends State<ClutchScreen> {
  final TextEditingController _tyreNameController = TextEditingController();
        ...
        child: SingleChildScrollView(
          child: Form(
            ...
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                _buildTextField('Name', _tyreNameController,
                    validator: (value) {
                  if (value == null || value.isEmpty) {
                    return 'Please enter clutch name';
                  }
                  return null;
                }),
                _buildTextField(
                ...
                _buildTextField('clutch Description', _descriptionController,
